...
-- CreateTable
CREATE TABLE "academic-facultys" (
    "id" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "academic-facultys_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "academic-departments" ADD CONSTRAINT "academic-departments_academicFacultyId_fkey" FOREIGN KEY ("academicFacultyId") REFERENCES "academic-facultys"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
